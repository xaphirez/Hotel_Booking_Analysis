...
An end-to-end data analytics project that explores **hotel booking 
behavior**, **customer trends**, **seasonality**, **cancellations**, 
and **revenue patterns** using **Python** for data preparation and 
**Tableau Public** for interactive business intelligence dashboards.
...
*(Click the dashboard image above to open the interactive 
Tableau dashboard.)*
...
Hotels generate thousands of booking records every year, but raw 
transactional data alone provides limited business value.

This project transforms hotel booking data into meaningful business 
insights by identifying booking patterns, customer behavior, revenue 
trends, and cancellation risks that can support data-driven 
decision-making.
...
The dataset contains **119,390 hotel bookings** from both 
**City Hotels** and **Resort Hotels**, including information such as:
...
- Removing 31,994 duplicate records (26.8% of original dataset)
- Filling missing values in `children`, `country`, `agent`, 
  and `company` columns
- Removing bookings with zero adults, zero nights, 
  or invalid ADR values
- Identifying and removing outlier records with 
  suspicious guest counts
- Final cleaned dataset: **85,371 rows** from original 119,390
...
Performed exploratory analysis to uncover booking behavior and 
customer trends. The following 12 business questions were 
investigated:

1. What is the average and maximum stay duration?
2. What is the average number of guests per booking?
3. What is the monthly revenue trend?
4. What percentage of guests received a room upgrade?
5. What percentage of bookings were made through an agent 
   or company?
6. Which month has the highest number of guest arrivals?
7. Which day of the week do most guests arrive?
8. What percentage of bookings require a parking space?
9. What is the overall cancellation rate?
10. What is the most popular meal plan?
11. How far in advance do guests typically book (lead time)?
12. What is the ratio of returning vs new guests?

---

## 4️⃣ Tableau Dashboard

Developed an interactive dashboard in **Tableau Public** to 
communicate key business insights through intuitive visualizations.

**Dashboard Features:**

- 📈 Monthly Revenue Trend (line chart)
- 🗺️ Bookings by Country (interactive world map)
- ❌ Cancellation Rate by Hotel Type (bar chart)
- 🍽️ Meal Plan Popularity (bar chart)
- 🔄 Room Change Analysis (bar chart)
- 👥 Returning vs New Guests (pie chart)
- 💰 Total Revenue, Total Bookings and Cancellation Rate 
  (scorecards)
- 🎛️ Interactive filters — click any chart to filter 
...
⭐ If you found this project interesting, feel free to star 
the repository and connect with me on LinkedIn!
